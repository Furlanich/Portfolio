...
name: typesafe-ai
license: MIT
description: Use when a feature needs programmable common sense with TypeSafe, when brainstorming AI capabilities, or when replacing an LLM prompt-and-parse step with typed judgments and probabilities for routing, ranking, extraction, verification, or interactive experiences.
---
