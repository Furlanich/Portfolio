...
- [`RFC-CONTACT-INQUIRY-PIPELINE`](contact-inquiry-pipeline.md): proposes Formspree behind a narrow `submitInquiry()` adapter for the current static-site release. It compares Cloudflare Worker + Resend and EmailJS, defines the security/privacy/abuse/testing boundary, and leaves implementation blocked until human approval plus the recorded provisioning, retention, legal, Privacy-page, and live-delivery gates.
