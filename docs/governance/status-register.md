...
- The Task 2 / PR 2 publication gate is satisfied by the three READY item records, and the merged implementation publishes only their approved image-free source-backed cards in both localized index routes. The Task 3 / PR 3 detail gate is satisfied by complete bilingual detail content, approved repository evidence links, and one labeled conceptual visual per item. Its review branch publishes no blocked, private, retired, or unresolved record.
