...
- tests/e2e/studio-founder-responsive.spec.ts
...
- playwright.config.ts, adding Studio/Founder behavior to chromium-desktop, adding 320x800 and 768x1024 focused responsive projects, including the focused responsive spec in the existing 390/1024/1440 Chromium projects, and adding one deterministic visual-chromium project
...
- npx playwright test tests/e2e/studio-founder.spec.ts --project=chromium-desktop
- npx playwright test tests/e2e/studio-founder-responsive.spec.ts
- npx playwright test tests/e2e/visual/studio.visual.spec.ts --project=visual-chromium
- npm run test:a11y
- npm run build
...
- npx playwright test tests/e2e/studio-founder.spec.ts --project=chromium-desktop
- npx playwright test tests/e2e/studio-founder-responsive.spec.ts
- npx playwright test tests/e2e/visual/founder.visual.spec.ts --project=visual-chromium
- npm run test:a11y
- npm run test:e2e
- npm run build
- npm run verify:static-export
