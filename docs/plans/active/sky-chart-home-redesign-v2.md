...
- **Chart-label legibility ladder (2026-09-24, Task 5 review S4).** Section 12's two-step rule (12 user units at ≥768, 24 below) renders labels at about 9.5px at 1024 and about 9.4px at 320. It is replaced by the container-query ladder now noted in section 12, which keeps rendered labels at 12px or more; below 300px the visible source list carries the labels. This is a plan-level spec fix, not a design change.
