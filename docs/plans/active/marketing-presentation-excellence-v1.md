...
| T6 | PR en preparación para revisión humana | Rama codex/marketing-presentation-pr6-final-audit, base d2fccf1; comparación auditable, matriz root/Portfolio, límites y revisión de documentación registrados abajo. |
...
El plan sigue `ACTIVE` hasta la aceptación humana del PR T6; la comparación, los índices y los límites están preparados para revisión. D03 sigue `REJECTED`, el informe original `PROPOSED`, y Contact/evidencia/identidad mantienen estados pendientes o diferidos explícitos.
