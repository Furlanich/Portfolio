...
interface FounderFinalCtaProps {
  content: FounderPageContent['finalCta'];
  actionHref: string;
}

export function FounderFinalCta({ content, actionHref }: FounderFinalCtaProps) {
  return (
    <section aria-labelledby="founder-final-cta-heading" className="bg-foundation-tint py-16 md:py-20 lg:py-24">
      <div className="mx-auto w-full max-w-[1200px] px-5 md:px-8 lg:px-12">
        <div className="max-w-[68ch]">
          <h2 id="founder-final-cta-heading" className="max-w-[20ch] text-[32px] font-bold leading-[38px] tracking-[-0.015em] text-foundation-ink md:text-[40px] md:leading-[48px]">
            {content.heading}
          </h2>
